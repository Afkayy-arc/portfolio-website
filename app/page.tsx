  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        {/* Other Projects */}
        <div className="mt-16">
          <h3 className="text-2xl md:text-3xl font-bold text-zinc-100 mb-8">
            More Projects
          </h3>
      ...
      <section id="experience" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {experience.map((exp, index) => (
            <div
              key={exp.id}
              className="group relative bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-8 hover:border-indigo-500/50 transition-all duration-300"
              style={{
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                ...
                <span className="text-zinc-500 font-medium mt-2 md:mt-0">
                  {exp.period}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {exp.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 text-sm bg-zinc-800/50 text-zinc-300 rounded-full border border-zinc-700"
                  >
                    {tech}
                  </span>
                ))}
